...
dat.fig.2.genes.pcoa <- read.csv("fifth_manuscript/Data/dat.fig2.genes.pcoa.csv")
...
tab <- read.csv("dat.fig2.abundance.csv")
d <- read.csv("dat.fig2.abundance.test.csv")
...
tab <- read.csv("dat.fig2.diversity.csv")
d <- read.csv("dat.fig2.diversity.test.csv")
d$p0.05 <- tolower(d$p0.05)
d$label <- d$p0.05
d$p0.1[is.na(d$p0.1)] <- ""
d[d$p0.1 == "a", "p0.1"] <- "c"
