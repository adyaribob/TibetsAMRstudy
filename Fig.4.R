...
dat.fig.4.module.tax.composition <- read.csv("fifth_manuscript/Data/dat.fig4.module.tax.composition.csv")
dat.fig.4.module.biomarker.strength <- read.csv("dat.fig4.module.biomarker.strength.csv")
dat.fig.4.shared.network.sediment.water.with.inf.baceuk <- read.csv("dat.fig4.shared.network.sediment.water.with.inf.baceuk.csv")

(fig.4.modules.tax.composition <- ggplot(dat.fig.4.module.tax.composition[dat.fig.4.module.tax.composition$lefse2 != "Nogroup", ], 
...
(fig.4.barchart.module.biomarker.strength <- ggplot(data = dat.fig.4.module.biomarker.strength, aes(x = lefse, y = log10(score+1))) + 
...
(fig.4.shared.edge.water.sediment.with.influent.barchart <- ggplot(data = dat.fig.4.shared.network.sediment.water.with.inf.baceuk,
                                                                aes(x = module, y = rel)) + 
